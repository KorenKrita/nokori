...
const pillStyles = (active: boolean) =>
  `inline-flex items-center rounded-sm text-xs font-medium transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${
    active
...
const labelButtonStyles =
  'border-0 bg-transparent p-0 font-inherit text-inherit cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-border-focus)] focus-visible:ring-offset-1 rounded-sm'
