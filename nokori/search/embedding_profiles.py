...
_GRANITE_OVERALL = BucketThresholds(
    ...
    medium_p10=0.8031,
    medium_p50=0.8500,
    near_miss_p95=0.9237,
    near_miss_p99=0.9481,
    negative_p99=0.8610,
...
_GRANITE_ZH = BucketThresholds(
    ...
    medium_p10=0.8300,
    medium_p50=0.8700,
    near_miss_p95=0.9232,
    near_miss_p99=0.9393,
    negative_p99=0.8500,
...
_GRANITE_MIXED = BucketThresholds(
    ...
    medium_p10=0.8200,
    medium_p50=0.8600,
    near_miss_p95=0.9286,
    near_miss_p99=0.9445,
    negative_p99=0.8600,
...
_GRANITE_CODE = BucketThresholds(
    ...
    medium_p10=0.8100,
    medium_p50=0.8500,
    near_miss_p95=0.9236,
    near_miss_p99=0.9319,
    negative_p99=0.8500,
